...
\setcounter{page}{1}
\input{sections/01-grundlagen}
\clearpage
\input{sections/02-zufallsvariablen}
\clearpage
\input{sections/03-integration}
\clearpage
\input{sections/04-erwartungswert_varianz}
\clearpage
\input{sections/05-verteilungen}
\clearpage
\input{sections/06-sonstiges}
\clearpage
